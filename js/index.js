...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function cargarProductos() {
        ...
        Object.keys(productosPorCategoria).forEach(categoria => {
            const seccion = productosContainer.querySelector(`.seccion h2`);
            let productosDiv = productosContainer.querySelector(`.seccion .productos`);
            ...
            <div class="producto" data-id="${producto.id}" data-nombre="${producto.nombre}" data-precio="${producto.precio}">
                ...
                <div class="controles-compra">
                    <div class="cantidad-control">
                        ...
                        <input type="number" class="cantidad-input" value="1" min="1" max="${producto.inventario}" readonly aria-label="Cantidad">
                        <button class="qty-btn" data-action="increase" aria-label="Aumentar cantidad">+</button>
                    </div>
                    <button class="boton" ${!disponible ? 'disabled style="opacity: 0.5;"' : ''}>
